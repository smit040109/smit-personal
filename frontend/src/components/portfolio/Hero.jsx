  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-32 right-[12%] h-24 w-24 rounded-3xl bg-[#2563EB]/5 border border-[#2563EB]/10 backdrop-blur-sm hidden md:block"
      />
      <motion.div
        animate={{ y: [0, 24, 0] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-40 left-[8%] h-16 w-16 rounded-full bg-[#16A34A]/5 border border-[#16A34A]/10 hidden md:block"
      />

      <motion.div style={{ opacity }} className="max-w-7xl mx-auto px-6 md:px-12 w-full pt-28 pb-16">
        <motion.div
        ...
        <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-black tracking-tighter text-[#111827] leading-[1.02] max-w-5xl">
        ...
        <motion.div
          ...
          className="mt-8 flex flex-wrap gap-x-3 gap-y-2 max-w-3xl"
        ...
        <motion.p
          ...
          className="mt-8 max-w-2xl text-base md:text-lg text-[#6B7280] leading-relaxed"
        >
          {HERO.intro}
        </motion.p>
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-3.5 text-sm font-semibold text-[#2563EB] hover:underline underline-offset-4"
          >
            <Download size={17} />
            Download Resume
          </a>
